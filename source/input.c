...
int input_read_parameters_species(struct file_content * pfc,
  ...
  if (flag2 == _TRUE_){
    ...
    // NEW: Read in relativistic neutrino decay parameters:        
     
    class_call(parser_read_double(pfc,"capY",&param1,&flag1,errmsg),                          // [1/s]
               errmsg,
               errmsg);
    ...
    class_test(((flag1 == _TRUE_) && (flag2 == _FALSE_)),
               errmsg,
               "If you specify the neutrino decay rate (capY) you should also specify the mother neutrino mass (capX).");
    class_test(((flag1 == _FALSE_) && (flag2 == _TRUE_)),
               errmsg,
               "If you specify the mother neutrino mass (capX) you should also specify the neutrino decay rate (X function).");   
  
  printf("Assuming relativistic neutrino decay with capY=%g Mpc and capX=%g \n", ppt->capY, ppt->capX);  
